...
import static database.DBConnector.*;
...
public class Servletdemo extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        String TABLE = "USERS";//request.getParameter("table");
...
//            con.setTransactionIsolation( con.TRANSACTION_READ_UNCOMMITTED );
            ...
            out.print("<form id=\"loginForm\" style=\"visibility: visible; color: #6F6D6F\" method=\"post\"\n" +
                    ...
                    "                                            <tr>\n" +
                    "                                                <td>Name:</td>\n" +
                    "                                                <td><input name=\"name\" type=\"login\" maxlength=\"40\" id=\"nameLog\"\n" +
                    "                                                           required></td>\n" +
                    "                                            </tr>\n" +
                    "                                            <tr>\n" +
                    "                                                <td>Пароль:</td>\n" +
                    ...
                    "                                        </table>\n" +
                    "                                    </form>" +
                    " <form action=\"lawer.jsp\" method=\"post\" enctype=\"text/plain\">\n" +
