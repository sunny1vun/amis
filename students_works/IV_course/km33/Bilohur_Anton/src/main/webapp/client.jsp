...
<li id=""><a href="file:///C:/Users/DELL/Documents/bootstrap-3.3.7-dist/client1.jsp"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> 
Clients</a></li> <li id=""><a href="file:///C:/Users/DELL/Documents/bootstrap-3.3.7-dist/client1.jsp" style="margin-left:20px"><span class="glyphicon glyphicon-star" aria-hidden="true"></span> My Page</a></li> 
...
<li id=""><a href="file:///C:/Users/DELL/Documents/bootstrap-3.3.7-dist/Main.jsp"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Blanks</a></li> 
...
<p class="roboto1">Age<span style="color:red">*</span>: 
<input type="text" id="check1" step="any" style="margin-right=5px; " placeholder="13" maxlength="2" required> 
</p>
<script>
...
<table  border="10" cellspacing="100" cellpadding="100" cols="4">
  <tr>
    <td>Process numb</td>
	<td>statuuuuus payment</td>
	<td><a href="my%20page.jsp" style="margin-left:20px">Lawyer 2</a> <td>
	<td>date</td>
  </tr>
</table>
...
<a href="mailto:sunn1vun@gmail.com" style="color:black;" target="_blank">saboiren444@gmail.com</a>
</div> 
<div class="col-xs-5"> 
