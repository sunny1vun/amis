...
<p class="roboto1" style="padding-top:50px">Name<span style="color:red">*</span>:
    <input name="name" type="login" maxlength="40" id="nameLog" required>    <%--<input name="name" type="login" maxlength="40" id="nameLog" required>--%>
</p>
<p class="roboto1">Password<span style="color:red">*</span>: 
<input name="pass" type="password" placeholder="password" maxlength="12" required>
</p>
<p class="roboto1">Role<span style="color:red">*</span>:
<input name="role" type="text" id="check2" step="any" style="margin-right:5px; "  placeholder="5" maxlength="2" required>
</p>
<script>
...
<p class="roboto1">Group<span style="color:red">*</span>:
     <input name="group" type="text" id="check" step="any" style="margin-right:5px; "  placeholder="5" maxlength="2" required>
</p>
     <p class="roboto1">Record book<span style="color:red">*</span>:
         <input name="recordBook" type="text" id="check1" step="any" style="margin-right:5px; "  placeholder="5" maxlength="2" required>
     </p>
